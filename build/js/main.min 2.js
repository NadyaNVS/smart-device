...
/* harmony import */ var _modules_add_parargaph__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/add-parargaph */ "./js/modules/add-parargaph.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_add_parargaph__WEBPACK_IMPORTED_MODULE_4__["showParagraph"])();
    Object(_modules_modals_scroll__WEBPACK_IMPORTED_MODULE_5__["initScroll"])();
...
function initAccordion() {
  var accordionButtons = document.querySelectorAll('[data-button]');
  var accordionContent = document.querySelectorAll('[data-content-menu]');
...
/***/ "./js/modules/add-parargaph.js":
/*!*************************************!*\
  !*** ./js/modules/add-parargaph.js ***!
  \*************************************/
/*! exports provided: showParagraph */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function showParagraph() {
  var paragraph = document.querySelector('[data-about-paragraph]');
  var paragraphButton = document.querySelector('[data-about-button]');
...
function initScroll() {
  var scrollButton = document.querySelector('.promo__button');
  var showContent = document.getElementById('question');
